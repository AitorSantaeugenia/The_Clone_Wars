...
const Movie = ({item}) => {
  ...
  return (
    ...
    {item?.backdrop_path ? 
    <div className="2xl:w-[280px] xl:w-[280px] lg:w-[280px] md:w-[240px] sm:w-[200px] smler:w-[200px] inline-block relative p-2 fantasy">
      <div>
      ...
      <Button onClick={showMovieDiv}>Open modal</Button>
      <Modal
        open={open}
      ...
      >
        <div className="max-w-[50%] min-w-[50%] flex flex-col justify-center">
          <div className="cursor-pointer relative w-full flex justify-end top-[46px] ">
